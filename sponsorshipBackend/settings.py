"""
Django settings for sponsorshipBackend project.
...
ROOT_URLCONF = 'sponsorshipBackend.urls'
...
WSGI_APPLICATION = 'sponsorshipBackend.wsgi.application'
...
DJOSER = {
    ...
    'SOCIAL_AUTH_ALLOWED_REDIRECT_URIS': ['https://dashboard.heroku.com/google', 'https://dashboard.heroku.com/facebook'],
    'SERIALIZERS': {
